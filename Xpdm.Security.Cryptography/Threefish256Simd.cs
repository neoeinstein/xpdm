...
namespace Xpdm.Security.Cryptography
{
    internal sealed class Threefish256Simd : ThreefishCipherSimd
    {
        ...
        public override void Encrypt(ulong[] input, ulong[] output)
        {
			...
			bA = bB + bA + keySchedule[1].GetVectorAligned(0);
			bTempA = Vector2ul.Zero.UnpackLow(bB);
			bTempB = Vector2ul.Zero.UnpackHigh(bB);
			...
			bA = bB + bA + keySchedule[2].GetVectorAligned(0);
			bTempA = Vector2ul.Zero.UnpackLow(bB);
			bTempB = Vector2ul.Zero.UnpackHigh(bB);
			bTempB = bTempB << 56 | bTempB >> (64 - 56);
			bTempA = bTempA <<  5 | bTempA >> (64 -  5);
			...
			bA = bB + bA + keySchedule[3].GetVectorAligned(0);
			bTempA = Vector2ul.Zero.UnpackLow(bB);
			bTempB = Vector2ul.Zero.UnpackHigh(bB);
			bTempB = bTempB << 20 | bTempB >> (64 - 20);
			bTempA = bTempA << 26 | bTempA >> (64 - 26);
			...
			bA = bB + bA + keySchedule[4].GetVectorAligned(0);
			bTempA = Vector2ul.Zero.UnpackLow(bB);
			bTempB = Vector2ul.Zero.UnpackHigh(bB);
			bTempB = bTempB << 56 | bTempB >> (64 - 56);
			bTempA = bTempA <<  5 | bTempA >> (64 -  5);
			...
			bA = bB + bA + keySchedule[5].GetVectorAligned(0);
			bTempA = Vector2ul.Zero.UnpackLow(bB);
			bTempB = Vector2ul.Zero.UnpackHigh(bB);
			bTempB = bTempB << 20 | bTempB >> (64 - 20);
			bTempA = bTempA << 26 | bTempA >> (64 - 26);
			...
			bA = bB + bA + keySchedule[6].GetVectorAligned(0);
			bTempA = Vector2ul.Zero.UnpackLow(bB);
			bTempB = Vector2ul.Zero.UnpackHigh(bB);
			bTempB = bTempB << 56 | bTempB >> (64 - 56);
			bTempA = bTempA <<  5 | bTempA >> (64 -  5);
			...
			bA = bB + bA + keySchedule[7].GetVectorAligned(0);
			bTempA = Vector2ul.Zero.UnpackLow(bB);
			bTempB = Vector2ul.Zero.UnpackHigh(bB);
			bTempB = bTempB << 20 | bTempB >> (64 - 20);
			bTempA = bTempA << 26 | bTempA >> (64 - 26);
			...
			bA = bB + bA + keySchedule[8].GetVectorAligned(0);
			bTempA = Vector2ul.Zero.UnpackLow(bB);
			bTempB = Vector2ul.Zero.UnpackHigh(bB);
			bTempB = bTempB << 56 | bTempB >> (64 - 56);
			bTempA = bTempA <<  5 | bTempA >> (64 -  5);
			...
			bA = bB + bA + keySchedule[9].GetVectorAligned(0);
			bTempA = Vector2ul.Zero.UnpackLow(bB);
			bTempB = Vector2ul.Zero.UnpackHigh(bB);
			bTempB = bTempB << 20 | bTempB >> (64 - 20);
			bTempA = bTempA << 26 | bTempA >> (64 - 26);
			...
			bA = bB + bA + keySchedule[10].GetVectorAligned(0);
			bTempA = Vector2ul.Zero.UnpackLow(bB);
			bTempB = Vector2ul.Zero.UnpackHigh(bB);
			bTempB = bTempB << 56 | bTempB >> (64 - 56);
			bTempA = bTempA <<  5 | bTempA >> (64 -  5);
			...
			bA = bB + bA + keySchedule[11].GetVectorAligned(0);
			bTempA = Vector2ul.Zero.UnpackLow(bB);
			bTempB = Vector2ul.Zero.UnpackHigh(bB);
			bTempB = bTempB << 20 | bTempB >> (64 - 20);
			bTempA = bTempA << 26 | bTempA >> (64 - 26);
			...
			bA = bB + bA + keySchedule[12].GetVectorAligned(0);
			bTempA = Vector2ul.Zero.UnpackLow(bB);
			bTempB = Vector2ul.Zero.UnpackHigh(bB);
			bTempB = bTempB << 56 | bTempB >> (64 - 56);
			bTempA = bTempA <<  5 | bTempA >> (64 -  5);
			...
			bA = bB + bA + keySchedule[13].GetVectorAligned(0);
			bTempA = Vector2ul.Zero.UnpackLow(bB);
			bTempB = Vector2ul.Zero.UnpackHigh(bB);
			bTempB = bTempB << 20 | bTempB >> (64 - 20);
			bTempA = bTempA << 26 | bTempA >> (64 - 26);
			...
			bA = bB + bA + keySchedule[14].GetVectorAligned(0);
			bTempA = Vector2ul.Zero.UnpackLow(bB);
			bTempB = Vector2ul.Zero.UnpackHigh(bB);
			bTempB = bTempB << 56 | bTempB >> (64 - 56);
			bTempA = bTempA <<  5 | bTempA >> (64 -  5);
			...
			bA = bB + bA + keySchedule[15].GetVectorAligned(0);
			bTempA = Vector2ul.Zero.UnpackLow(bB);
			bTempB = Vector2ul.Zero.UnpackHigh(bB);
			bTempB = bTempB << 20 | bTempB >> (64 - 20);
			bTempA = bTempA << 26 | bTempA >> (64 - 26);
			...
			bA = bB + bA + keySchedule[16].GetVectorAligned(0);
			bTempA = Vector2ul.Zero.UnpackLow(bB);
			bTempB = Vector2ul.Zero.UnpackHigh(bB);
			bTempB = bTempB << 56 | bTempB >> (64 - 56);
			bTempA = bTempA <<  5 | bTempA >> (64 -  5);
			...
			bA = bB + bA + keySchedule[17].GetVectorAligned(0);
			bTempA = Vector2ul.Zero.UnpackLow(bB);
			bTempB = Vector2ul.Zero.UnpackHigh(bB);
			bTempB = bTempB << 20 | bTempB >> (64 - 20);
			bTempA = bTempA << 26 | bTempA >> (64 - 26);
